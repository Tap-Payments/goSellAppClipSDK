...
internal class RSAUtilsError: NSError {
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func deleteRSAKeyFromKeychain(_ tagName: String) {
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func getRSAKeyFromKeychain(_ tagName: String) -> SecKey? {
        let queryFilter: [String: AnyObject] = [
            String(kSecClass)             : kSecClassKey,
            String(kSecAttrKeyType)       : kSecAttrKeyTypeRSA,
            String(kSecAttrApplicationTag): tagName as AnyObject,
     ...
     */
    @available(iOS, introduced: 1.2.0)
    @discardableResult internal static func addRSAPrivateKey(_ privkeyBase64: String, tagName: String) throws -> SecKey? {
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func addRSAPublicKey(_ pubkeyBase64: String, tagName: String) throws -> SecKey? {
        let regExp = try! NSRegularExpression(pattern: "(-----BEGIN.*?-----)|(-----END.*?-----)|\\s+", options: [])
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func encryptWithRSAKey(_ data: Data, rsaKeyRef: SecKey, padding: SecPadding) -> Data? {
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func decryptWithRSAKey(_ encryptedData: Data, rsaKeyRef: SecKey, padding: SecPadding) -> Data? {
        let blockSize = SecKeyGetBlockSize(rsaKeyRef)
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func encryptWithRSAKey(data: Data, tagName: String) -> Data? {
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func encryptWithRSAKey(str: String, tagName: String) -> Data? {
        let keyRef = getRSAKeyFromKeychain(tagName)
        if ( keyRef == nil ) {
            return nil
        }
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func decryptWithRSAKey(encryptedData: Data, tagName: String) -> Data? {
        let keyRef = getRSAKeyFromKeychain(tagName)
        if ( keyRef == nil ) {
            return nil
        }
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func encryptWithRSAPublicKey(data: Data, pubkeyBase64: String) throws -> Data? {
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func encryptWithRSAPublicKey(str: String, pubkeyBase64: String) throws -> Data? {
        let tagName = "PUBIC-" + String(pubkeyBase64.hashValue)
        var keyRef = getRSAKeyFromKeychain(tagName)
        if ( keyRef == nil ) {
            keyRef = try addRSAPublicKey(pubkeyBase64, tagName: tagName)
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func encryptWithRSAPublicKey(data: Data, pubkeyBase64: String, tagName: String) throws -> Data? {
        var keyRef = getRSAKeyFromKeychain(tagName)
        if ( keyRef == nil ) {
            keyRef = try addRSAPublicKey(pubkeyBase64, tagName: tagName)
        }
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func encryptWithRSAPublicKey(str: String, pubkeyBase64: String, tagName: String) throws -> Data? {
        var keyRef = getRSAKeyFromKeychain(tagName)
        if ( keyRef == nil ) {
            keyRef = try addRSAPublicKey(pubkeyBase64, tagName: tagName)
        }
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func decryptWithRSAPrivateKey(encryptedData: Data, privkeyBase64: String) throws -> Data? {
     ...
     */
    @available(iOS, introduced: 1.2.0)
    internal static func decryptWithRSAPrivateKey(encryptedData: Data, privkeyBase64: String, tagName: String) throws -> Data? {
        var keyRef = getRSAKeyFromKeychain(tagName)
        if ( keyRef == nil ) {
            keyRef = try addRSAPrivateKey(privkeyBase64, tagName: tagName)
        }
